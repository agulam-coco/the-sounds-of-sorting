    ...
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //copy of indices array
                Integer[] disposableCopy = notes.getNotes().clone();

                List<SortEvent<Integer>> events = generateEvents((String) sorts.getSelectedItem(), disposableCopy);

                //store for compare events
                List<SortEvent<Integer>> found = new ArrayList<SortEvent<Integer>>();
